...
tellraw @a {text:"<BoozeCraft> ", bold:true, color:"light_purple", extra:[{text:"EVERYONE EXCEPT ", bold: true, color:"red"}, {selector:"@s", bold:true, color:"aqua"}, {text:" has to drink since: ", bold:true, color:"green"}]}